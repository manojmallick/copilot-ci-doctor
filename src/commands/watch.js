...
export async function watchCommand(options = {}) {
  ...
  try {
    ...
    // Final scoreboard
    printWatchScoreboard(startTime, history, totalInputTokens, totalOutputTokens);
 ...
 */
function printWatchScoreboard(startTime, history, totalInputTokens, totalOutputTokens) {
